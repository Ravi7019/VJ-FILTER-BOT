...
BOT_TOKEN = environ.get('BOT_TOKEN', "6549227192:AAFKXtWe9l4r6Zlyhinnq4No2NwQoAfQ6Co")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002241229481')).split()]
